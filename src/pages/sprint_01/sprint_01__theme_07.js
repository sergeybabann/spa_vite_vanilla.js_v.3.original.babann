export default function Sprint_01_Theme_07() {
  ...
  <div class="main">
      ...
      <h1 class="main__title-1">Тема 7: Расскажите про ваше обучение</h1>
          
          <h3 class="main__title-3">Уроки</h3>
          <!----- Lessons ----->
          <ul class="main__list-1">
          <li class="main__list-1-item">
              <a class="main__link-default" href="/sprint_01/theme_07/lesson_01">1. Расскажите про ваше обучение</a>         
          </li>
